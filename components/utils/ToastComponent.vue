...
<template>
  <div 
  class="transition ease-in-out duration-500 bg-white font-notoSans text-xs p-4 rounded-lg shadow-lg fixed bottom-5 right-5 z-50" 
  
  :class="store.show ? 'scale-100': 'scale-0'">
