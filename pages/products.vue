  ...
  <section>
    <!-- ! Main -->
     <div class="flex items-start w-4/5 mx-auto gap-5 mt-5">
      ...
      <!-- ! Filter -->
      <form @submit.prevent="1" class="border-2 space-y-4 flex flex-col w-[30%] border-orange-500 p-6 text-center rounded-lg shadow-md bg-gray-100">
      ...
      <div class="border-2 space-y-4 flex flex-col mb-10 border-orange-500 p-6 w-[70%] text-center rounded-lg shadow-md bg-gray-100">
        ...
        <!-- *Productos -->
         <div class="grid grid-cols-3 grid-rows-2 gap-5">
          <ProductComponent v-for="(item, index) in productItems" 
          :key="index" 
          :image="item.image" 
