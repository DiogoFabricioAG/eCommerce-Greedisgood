<template>
  <section>
    <HeaderComponent />
    <RouteComponent :textRoutes="['Inicio', 'Comunidad']" :linkRoutes="['/','/community']"/>
  </section>
  <section>
    <div class="flex flex-col gap-2 font-monserrat items-center justify-center">
      ...
      <p class="text-center text-sm ">Interactúa con la Comunidad de <span class="text-orange-500 font-bold">GreedisGood</span></p>
    </div>
    <div class="grid grid-cols-3 gap-10 w-4/5 mx-auto mt-10">
      <BoxRouteComponent v-for="(item, index) in BoxRouteList" 
        :key="index" 
        :title="item.title" 
        :type-image="index+1" 
